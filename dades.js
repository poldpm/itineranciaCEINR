...
const CAMPS_NORD = [
  { id: "veh_aparcament", etiqueta: 'Número de vehicles en "aparcament"', tipus: "number", obligatori: false },
  { id: "veh_fora_aparcament", etiqueta: 'Número de vehicles fora "aparcament"', tipus: "number", obligatori: false },
  { id: "veh_impedeixen_pas", etiqueta: "Número de vehicles que impedeixen el pas", tipus: "number", obligatori: false },
  { id: "veh_sense_autoritzacio", etiqueta: "Número de vehicles SENSE autorització d'accés", tipus: "number", obligatori: false },
  { id: "tendes", etiqueta: "Tendes", tipus: "number", obligatori: false },
  { id: "autocaravana_pernocta", etiqueta: "Autocaravana / furgoneta en pernocta", tipus: "number", obligatori: false },
  { id: "camping_excessiu", etiqueta: "Vehicles amb elements de càmping excessius (més d'una taula i 2 cadires)", tipus: "number", obligatori: false },
  ...
  { id: "veh_fora_pista", etiqueta: "Número de vehicles motoritzats fora de pista (cotxes, bicis elèctriques, motos, etc.)", tipus: "number", obligatori: false },
  { id: "bicicletes", etiqueta: "Número de bicicletes", tipus: "number", obligatori: false },
  { id: "persones", etiqueta: "Número de persones", tipus: "number", obligatori: false },
...
const CAMPS_SUD_CAVALLERA = [
  ...
  { id: "deixalles", etiqueta: "Nivell de deixalles", tipus: "escala", opcions: ["1", "2", "3", "4", "5"], etiquetaMin: "Poques", etiquetaMax: "Moltes", obligatori: false },
  { id: "veh_fora_pista", etiqueta: "Número de vehicles motoritzats fora de pista (cotxes, bicis elèctriques, motos, etc.)", tipus: "number", obligatori: false },
  { id: "escaladors", etiqueta: "Número d'escaladors", tipus: "number", obligatori: false },
  { id: "bicicletes", etiqueta: "Número de bicicletes", tipus: "number", obligatori: false },
  { id: "persones", etiqueta: "Número de persones", tipus: "number", obligatori: false },
  { id: "observacions", etiqueta: "Observacions", tipus: "textarea", obligatori: false }
];

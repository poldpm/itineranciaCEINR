...
const DADES = {
  arees: [
    ...
    },
    {
      ...
      trams: [
        { num: 3,  nom: "Orri Vell" },
        { num: 5,  nom: "Bruguera - La Blanquina" },
        { num: 7,  nom: "La Blanquina - Coll de Jou" },
        { num: 9,  nom: "Pujada Taga" },
        { num: 10, nom: "Coll de Jou - Trencant Ribamala" },
        { num: 11, nom: "Trencant Ribamala - St. Martí d'Ogassa" },
        { num: 13, nom: "St. Martí d'Ogassa - Cingleres can Camps" },
        { num: 15, nom: "Cingleres can Camps - Collada Caritat" },
        { num: 17, nom: "Cruïlla Can Picola - Cal Frare" },
        { num: 19, nom: "Pujada Gran Jaça (a peu)" },
        { num: 20, nom: "Collada Caritat - Pla d'en Plata" }
      ],
      aparcaments: [
        { num: 1,  nom: "P. Puigsac" },
        { num: 2,  nom: "P. Foranques" },
        { num: 4,  nom: "P. Barranc de la Corba" },
        { num: 6,  nom: "P. La Blanquina" },
        { num: 8,  nom: "P. Coll de Jou" },
        { num: 12, nom: "P. St. Martí d'Ogassa" },
        { num: 14, nom: "P. Cingleres can Camps" },
        { num: 16, nom: "P. Collada Caritat" },
        { num: 18, nom: "P. Cal Frare" },
        { num: 21, nom: "P. Pla d'en Plata" }
      ]
    }
  ]
};

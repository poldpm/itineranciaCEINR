...
const Mapa = (function () {
  ...
  const CALIB_DEFECTE = {
    'AI Serra Cavallera': {
      p1: { px: 2098.83, py: 674.62, lat: 42.28603, lng: 2.32342 },
      p2: { px: 759.55, py: 250.08, lat: 42.3083, lng: 2.22706 }
    },
    'AI Serra de Montgrony Nord': {
      p1: { px: 122.71, py: 155.20, lat: 42.31726, lng: 2.05026 },
      p2: { px: 1326.52, py: 1039.37, lat: 42.27988, lng: 2.12049 }
    },
    'AI Serra de Montgrony Sud': {
      p1: { px: 221, py: 1437, lat: 42.26037, lng: 2.05422 },
      p2: { px: 1221, py: 1033, lat: 42.27060, lng: 2.08586 }
    }
  };
